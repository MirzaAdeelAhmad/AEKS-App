  ...
  return (
    <View style={{flex: 1, backgroundColor: appColors.background}}>
      ...
      <View
        ...
        <Text
          style={{fontSize: 15, color: appColors.background, paddingLeft: 10}}>
          In delivery
        </Text>
      </View>
      {/* ----------------- Map ----------------- */}
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          ...
          <Text
            style={{fontSize: 14, color: appColors.textgray, paddingLeft: 10}}>
            Pickup:
          </Text>
          <Text style={{fontSize: 14, color: appColors.textGrayBlue}}>
            {' '}
            1300 E Wilsum Ave, CA 91206
          </Text>
        </View>
      ...
      <OrderSentComponent
        Name={'My shipments'}
        OrderPosition={'Successfully sent!'}
        onBtnPress={() => Navigation.navigate('OrderRecieved')}
      />
    </View>
  );
}
